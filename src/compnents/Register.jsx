  ...
  return (
    <div className='register bg-gray-100 w-full text-black pt-5 font-bold '>
      <div className='flex flex-col justify-center items-center'>
        ...
        <h1 className='text-2xl'>註冊會員</h1>
        <h4 className='text-md'>或者 <Link to='/price-watch-observer-client/login' className=' text-blue-500 text-md'>有會員了嗎? 點此登入</Link></h4>
      </div>
      <div className='flex flex-col justify-center items-center bg-white w-full pt-5 mt-3 shadow-xl'>
        <form action="" className='flex flex-col w-4/5'>
          ...
          <input type="text" name='username' className=' border border-gray-400 rounded-md pl-2' />
          ...
          <button className=' bg-red-500 text-white rounded-md mt-5 p-1'>註冊</button>
          <h4 className='text-center text-gray-400 mt-3 before:content-[""] border-b border-gray-400 '>第三方註冊</h4>
